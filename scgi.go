/*
Package scgi provides an SCGI server implementation, for use with the http package.

Serve can be used as a replacement for http.Serve:

	http.Handle("/foo", fooHandler)
	l, err := net.Listen("tcp", "localhost:5000")
	...
	err = scgi.Serve(l, nil)
	...

The SCGI protocol is defined at http://python.ca/scgi/protocol.txt
*/
package scgi
...
// Serve accepts incoming SCGI connections on the listener l, creating
// a new service goroutine for each. The service goroutines read a request
